...
export async function createDriver(companyId: string, userId: string, input: DriverInput, client?: DbClient) {
...
export async function updateDriver(companyId: string, userId: string, id: string, input: DriverInput, client?: DbClient) {
  const supabase = await getDbClient(client)
