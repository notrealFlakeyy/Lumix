  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        />
        <div
          className="lumix-blob-c absolute bottom-[-4rem] right-[-8rem] h-[400px] w-[400px] rounded-full opacity-20"
          style={{
        ...
        <div className="grid w-full max-w-5xl items-center gap-16 lg:grid-cols-[1fr_420px]">
          ...
          <div className="lumix-rise-1 space-y-8">
            <div>
              ...
              >
                One workspace for transport, finance, workforce, and more. No credit card
                required to get started — pick your plan after signup.
              </p>
            </div>
          ...
          <div className="lumix-rise-2">
            ...
            >
              ...
              >
                ...
                <Link href="/login" className="font-medium underline-offset-2">
                  Sign in
                </Link>
              </p>
            </div>
